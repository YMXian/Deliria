...
//
//  Reference: https://github.com/yeahdongcn/UIColor-Hex-Swift/blob/master/HEXColor/UIColorExtension.swift
//
...
extension UIColor {
  ...
  /**
   ...
   - parameter includingAlpha: Whether the alpha should be included.
