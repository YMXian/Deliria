...
// Button sub-class
public class AlertViewButton: UIButton {
...
public class AlertViewResponder {
    ...
    public func setVoidBlock(dismissBlock: VoidBlock) {
...
public class AlertView: UIViewController {
    ...
    override public func viewDidAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AlertView.keyboardWillShow(_:)), name:UIKeyboardWillShowNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AlertView.keyboardWillHide(_:)), name:UIKeyboardWillHideNotification, object: nil)
    }
    ...
    public func addButton(title: String, backgroundColor: UIColor? = nil, textColor: UIColor? = nil, showDurationStatus: Bool=false, action:() -> Void) -> AlertViewButton {
        ...
        btn.action = action
        btn.addTarget(self, action:#selector(AlertView.buttonTapped(_:)), forControlEvents:.TouchUpInside)
        btn.addTarget(self, action:#selector(AlertView.buttonTapDown(_:)), forControlEvents:[.TouchDown, .TouchDragEnter])
        btn.addTarget(self, action:#selector(AlertView.buttonRelease(_:)), forControlEvents:[.TouchUpInside, .TouchUpOutside, .TouchCancel, .TouchDragOutside] )
        return btn
    }

    public func addButton(title: String, backgroundColor: UIColor? = nil, textColor: UIColor? = nil, showDurationStatus: Bool = false, target: AnyObject, selector: Selector) -> AlertViewButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showDurationStatus: showDurationStatus)
    ...
    private func addButton(title: String, backgroundColor: UIColor? = nil, textColor: UIColor? = nil, showDurationStatus: Bool=false) -> AlertViewButton {
        // Update view height
    ...
    func buttonTapped(btn: AlertViewButton) {
    ...
    func buttonTapDown(btn: AlertViewButton) {
        var hue: CGFloat = 0
    ...
    func buttonRelease(btn: AlertViewButton) {
    ...
    public func showCustom(title: String, subTitle: String, color: UIColor, icon: UIImage, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showSuccess(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showError(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Error.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showNotice(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Notice.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showWarning(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Warning.defaultColorInt, colorTextButton: UInt=0x000000, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showInfo(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showWait(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt?=AlertViewStyle.Wait.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showEdit(title: String, subTitle: String, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt=AlertViewStyle.Edit.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showTitle(title: String, subTitle: String, style: AlertViewStyle, closeButtonTitle: String?=nil, duration: NSTimeInterval=0.0, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
    ...
    public func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: AlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: AlertViewAnimationStyle = .TopToBottom) -> AlertViewResponder {
        selfReference = self
        view.alpha = 0
        let rv = UIApplication.sharedApplication().keyWindow! as UIWindow
        rv.addSubview(view)
        ...
        case .Error:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: AlertViewStyleKit.imageOfCross)
        ...
        case .Warning:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: AlertViewStyleKit.imageOfWarning)

        case .Info:

            iconImage = checkCircleIconImage(circleIconImage, defaultImage: AlertViewStyleKit.imageOfInfo)

        case .Edit:

            iconImage = checkCircleIconImage(circleIconImage, defaultImage: AlertViewStyleKit.imageOfEdit)
        ...
        if appearance.showCloseButton {
            addButton(completeText ?? "Done", target:self, selector:#selector(AlertView.hideView))
        }
    ...
    private func showAnimation(animationStyle: AlertViewAnimationStyle = .TopToBottom, animationStartOffset: CGFloat = -400.0, boundingAnimationOffset: CGFloat = 15.0, animationDuration: NSTimeInterval = 0.2) {
